    ...
    public partial class MainForm
    {
        ...
        private void JudgementSyntaxHelpButton_Click(object sender, EventArgs e)
        {
            ...
            using (var textBox = new TextBox())
            {
                ...
                textBox.Text = BuildJudgementSyntaxHelpTextV5();
        ...
        private static string BuildJudgementSyntaxHelpTextV3()
        {
            return string.Join(Environment.NewLine, new[]
            {
                "判斷語法說明",
                ...
                "   - min((1),(2),(3))",
                "   - 任何子項若找不到物件，會先忽略該子項",
                "   - 只有全部子項都找不到物件時，結果才視為 0",
                "   - 例如 min(((2)-(1)),((4)-(3)))，若 (2)-(1) 無法量測，則只用剩下的子項",
                "",
                "3. 巢狀運算",
                "   - max(((2)-(1))((4)-(3)))",
                "   - min(((2)-(1)),((4)-(3)))",
        ...
        private static string BuildJudgementSyntaxHelpTextV4()
        {
            return string.Join(Environment.NewLine, new[]
            {
                "判斷語法說明",
        ...
        private static string BuildJudgementSyntaxHelpTextV5()
        {
            return string.Join(Environment.NewLine, new[]
            {
                "判斷語法說明",
                ...
                "   - min((1),(2),(3))",
                "   - 子項若因缺值無法完整計算，會直接忽略",
                "   - 例如 min((1)-(2),(3)) 時，如果 (2) 沒有值，就只用 (3) 去算",
                "   - 只有所有子項都無法使用時，結果才視為 0",
                "",
                "3. 巢狀運算",
                "   - max(((2)-(1))((4)-(3)))",
                "   - min(((2)-(1)),((4)-(3)))",
